...
export default function Home() {
  ...
  // makes the input for the users when commenting adjust so user can see everything they type
  ...
  // onChange={handleInputChange} style={{ height }}
                        ...
                        <div className="flex justify-between">
                          <div>
                            ...
                            <p className="text-black text-xs">
                              Wow hello this is really cool. Let's connect and
                              get together. I am really interested in what you
                              said in this post!
                            </p>
                          </div>
