...
export default function Home() {
    return (
        <>
        {/* Classes for header */}
        {/* lg:my-10 lg:mx-60 md:my-10 md:mx-40 sm:my-10 sm:mx-40 my-10 mx-20 rounded-md p-4 grid grid-cols-6 bg-gray-600 */}

        {/* Make it so when there is a post button where when you click, then this section will expand!!! */}
            <header className=''>
                <div className="heading text-center font-bold text-2xl m-5 text-gray-800">New Post</div>
                    ...
                    {/* <!-- buttons --> */}
                    <div className="buttons flex mx-2 my-3">
                        <div className="btn border border-gray-200 p-1 px-4 font-semibold cursor-pointer text-gray-500 ml-auto rounded-lg">Cancel</div>
                        <div className="btn border border-teal-500 p-1 px-4 font-semibold cursor-pointer text-gray-200 ml-2 bg-teal-500 rounded-lg">Post</div>
                    </div>
                </div>
            </header>
                    ...
                    <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-gray-100 shadow-lg">
                        <div className="p-6 flex flex-col justify-start">
                            <div className='flex justify-between mb-3'>
                                <div className=''>
                                    <h5 className="text-gray-900 text-xl font-medium mb-1 bold">Jose Jenkins</h5>
                                    <h6 className="text-gray-500 text-sm font-medium mb-1">Secret FBI Agent</h6>
                                </div>
                                {/* Make a responsive date change !!! */}
                                <div className='mr-2'>
                                    <h6 className="text-gray-500 text-xs font-medium">11/12/2022</h6>
                                </div>
                            </div>
                        

                        <p className="text-gray-700 text-base mb-4">
                            <h5 className='text-gray-900 text-md bold'>Title of Post Here</h5>
                        ...
                        <div className="px-6 py-4 flex justify-between">
                            {/* Could leave like this ... or make flex-col and add uncommented section to have post button beneath the comment section */}
                            <div className='flex'>
                                {/* <div> */}
                                    {/* TO DO: MAKE IT SO AS THE USER TYPES, the comment input section gets bigger with the user. Also would like it to be a bit wider . . . */}
                                    <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-full py-2 pl-9 pr-3 text-slate-600 shadow-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 focus:ring-1 sm:text-sm" placeholder="Add a comment" type="text" name="comment"/>
                                {/* </div> */}

                                {/* <div className='mt-2'> */}
                                    <button className="bg-gray-900 hover:bg-gray-800 text-white font-bold py-1 px-3 rounded-full text-sm ml-1">Post</button>
                                {/* </div> */}
                            </div>
