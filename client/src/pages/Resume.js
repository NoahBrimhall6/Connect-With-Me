...
export default function Resume() {
            ...
            sections: [
                {
                    children: [
                        ...
                        new Paragraph({ text: ``, heading: HeadingLevel.HEADING_1}),
                        new Paragraph({ text: ``, heading: HeadingLevel.HEADING_1}),
                        new Paragraph({ text: `${prevJ1Title} ${prevJ1Length}`, heading: HeadingLevel.HEADING_2 }),
                        new Paragraph({ text: prevJ1Company, heading: HeadingLevel.HEADING_4 }),
                        ...
                        new Paragraph({ text: ``, heading: HeadingLevel.HEADING_1}),
                        new Paragraph({ text: `${prevJ2Title} ${prevJ2Length}`, heading: HeadingLevel.HEADING_2 }),
                        new Paragraph({ text: prevJ2Company, heading: HeadingLevel.HEADING_4 }),
                        ...
                        new Paragraph({ text: ``, heading: HeadingLevel.HEADING_1}),
                        new Paragraph({ text: `${prevJ3Title} ${prevJ3Length}`, heading: HeadingLevel.HEADING_2 }),
                        new Paragraph({ text: prevJ3Company, heading: HeadingLevel.HEADING_4 }),
    ...
    return (
        <div className='contactConatainer xl:mx-20 lg:mx-10 md:mx-5 sm:mx-5 mx-5 my-10'>
            ...
            <form className='contactForm m-3 bg-gray-800 p-4 rounded-lg'>
                <h2 className='bold text-2xl text-white mb-1'>Basic Information</h2>
                <div className="mb-3 mx-1">
                    ...
                    <input
                        ...
                        className="form-control rounded-md p-1 bg-gray-200"
                        id="fullName"
                ...
                <div className="mb-3 mx-1">
                    ...
                    <input
                        ...
                        type="text"
                        onChange={handleInputChange}
                        className="education form-control rounded-md p-1 bg-gray-200"
                        id="education"
                        placeholder="What Education do you have?">
                    </input>
                </div>
                <br></br>
                <h2 className='bold text-2xl text-white mb-1'>Previous Experience</h2>
                <div className="mb-3 mx-1">
